...
from settings import TOKEN, API
...
class Request:
    ...
    def _client_info(self, type: str, id: str) -> dict:
        """
    ...
    def _get_clients_all(self, limit: int = 100, offset: int = 0) -> dict:
        """
    ...
    def _get_clients_new(self, limit: int = 100) -> dict:
        """
    ...
    def _update_registration_organisation(self, organisation: dict) -> dict:
        """
        Регистрация организации

        :param organisation: данные об организации
        Пример organisation
        {
        ...
        {
            "response": {
                "message": "Registration successful.",  # cообщение
                "status": "1"   # 1 – изменения приняты, 0 – регистрация запрещена
            }
        }
        """
        return self._send_request(
    ...
    def _get_update_integration(self, integration: dict):
        """
    ...
    def _create_clients(self, clients: list) -> dict:
        """
        Создать клиентов
    ...
    def _get_tag(self, tag_id: int) -> dict:
        """
    ...
    def _create_tags(self, tag_names: list) -> dict:
        """
        Создать теги
    ...
    def _send_card_sms(self, client_id: int, message: str, unix_time: str):
        """
        Отправить SMS
    ...
    def _update_vars(self, client_id: int, variables: dict):
        """
    ...
    def _get_orders_new(self, limit: int = 100) -> dict:
        """
    ...
    def _create_order(self, type: str, id: str, order: dict) -> dict:
        """
    ...
    def _update_order(self, type: str, id: str, order: dict) -> dict:
        """
    ...
    def _return_order(self, order: dict) -> dict:
        """
    ...
    def _return_cart(self, type: str, id: str, cart: dict) -> dict:
        """
        Возврат товара
    ...
    def _update_return_cart(self, type: str, id: str, cart: dict) -> dict:
        """
        Возврат товара
