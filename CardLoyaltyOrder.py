...
class Order(CardLoyaltyBasic.Basic):
    def __init__(self,
        ...
        :param guid: ID транзакции
        :param number: номер транзакции
        :param date: дата транзакции
        :param basket: корзина заказа
        :param bonus_add: начислено бонусов
        :param bonus_write_off: списано бонусов
        :param deposit_add: пополнение депозита
        :param deposit_write_off: списание с депозита
        """
        super().__init__()
        self._basket = basket
        self._order = {
    ...
    def get_order_basket(self) -> CardLoyaltyBasket.Basket:
        ...
        :return: объект класса CardLoyaltyBasket.Basket
        """
        return self._basket
    ...
    def get_order_price_with_discount(self) -> float:
        """
        Получить стоимость заказа со скидкой
